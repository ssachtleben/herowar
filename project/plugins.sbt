...
addSbtPlugin("com.ssachtleben" % "sbt-assets-handlebars" % "1.0.1-SNAPSHOT")
addSbtPlugin("com.ssachtleben" % "sbt-assets-define" % "1.0.4-SNAPSHOT")
addSbtPlugin("com.ssachtleben" % "sbt-assets-concat" % "1.0.2-SNAPSHOT")
