...
public class Geometry extends BaseModel implements Serializable {
	...
	public String toString() {
		return "Geometry [id=" + id + ", vertices=" + vertices + ", faces=" + faces + ", morphTargets=" + morphTargets + ", morphColors="
				+ morphColors + ", normals=" + normals + ", colors=" + colors + ", uvs=" + uvs + ", scale=" + scale + ", type=" + type
				+ ", metadata=" + metadata + ", terrain=" + terrain + ", meshes=" + meshes + ", geoMaterials=" + geoMaterials + ", matIdMapper="
				+ matIdMapper + ", materials=" + materials + "]";
	}
