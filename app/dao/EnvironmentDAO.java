...
public class EnvironmentDAO extends TreeDAO<Long, Environment> {
   ...
   public List<Environment> getEnvWithGeometries(Long id) {
   ...
   private void getChildGeometries(List<Environment> set, Long startId) {
   ...
   private Environment getEnvFromRow(Object[] row, int geoIndex) {
